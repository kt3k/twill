...
// PropertyOrder is the global property order (SPEC §11.4), verbatim.
...
var propertyIndex = map[string]int{}
...
// PropertyIndex returns the index of a property in the global order, or -1.
func PropertyIndex(property string) int {
	if i, ok := propertyIndex[property]; ok {
		return i
	}
	return -1
}
